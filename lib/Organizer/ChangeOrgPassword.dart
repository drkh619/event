...
class ChangeOrgPasswordPage extends StatefulWidget {
  @override
  _ChangeOrgPasswordPageState createState() => _ChangeOrgPasswordPageState();
}

class _ChangeOrgPasswordPageState extends State<ChangeOrgPasswordPage> {
  ...
  Future<void> _changePassword() async {
    final String url = "$ip_address/Event_Management/Organise/change_password.php";
