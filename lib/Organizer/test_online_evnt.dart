...
class test_online_event extends StatefulWidget {
  @override
  _test_online_eventState createState() => _test_online_eventState();
}

class _test_online_eventState extends State<test_online_event> {
  var _image;
//  final picker = ImagePicker();
  ...
  Future uploadImage() async {
    ...
    request.fields['event_link'] = eventVenue.text;
